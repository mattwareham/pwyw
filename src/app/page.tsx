    ...
    <>
      <main>
              ...
              >
                {session.notThis.map((item) => (
                  <li key={item} style={markerRow}>
                    <span
                      aria-hidden
                      style={{ ...marker, color: "var(--cp-ogre-odor)" }}
                    >
                      ✗
                    </span>
                ...
                {session.butThis.map((item) => (
                  <li key={item} style={markerRow}>
                    <span
                      aria-hidden
                      style={{ ...marker, color: "var(--fg-positive)" }}
                    >
                      ✓
                    </span>
        ...
        <section
          ...
          style={{
            ...whiteBand,
            borderTop: "var(--border-w-hair) solid var(--border-2)",
          }}
        >
          <div style={frame}>
            <div style={textColumn}>
              ...
              <p style={{ ...bodyText, marginTop: "var(--space-6)" }}>
                {outcome.closingLine}
              </p>
            </div>
          </div>
        ...
        {/* The amounts, then the pay-what-you-like explanation */}
        <PaymentOptions />
